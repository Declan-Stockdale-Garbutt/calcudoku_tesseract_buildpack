...
This package provide a custom Heroku buildpack providing the [Tesseract OCR](https://code.google.com/p/tesseract-ocr/) binary and all the required libraries to Heroku apps. 
...
1. setup your app as  
    ...
    heroku buildpacks:add https://github.com/Declan-Stockdale/calcudoku_tesseract_buildpack/
    ```
